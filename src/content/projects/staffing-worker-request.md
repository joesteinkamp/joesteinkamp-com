...
1. The first project prioritized from design vision work that was a part of an innovation week. It was the blueprint that operationalized our design vision process.
2. A more advanced template system that was advocated for based on how our users expect the organization of the information that pushed our engineers to go beyond a more common templating system. (Multiple templates per request versus a single template for all information).
